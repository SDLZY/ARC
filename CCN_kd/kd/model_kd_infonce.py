...
class ModelKDInfoNCE(Model):
    ...
    def forward(
        ...
        if features_penult_qr2a is not None:
            features_penult_qa2r = output_dict['features_penult_2']
            loss_infonce, infonce_info = self.infonce_comp(features_penult_qr2a, input_dict_1['label'], features_penult_qa2r,
                                             input_dict_2['label'])
