...
Val epoch 0  q2a_acc 0.5639 qa2r_acc 0.5723 (c 0.5787 w 0.5639) q2ar_acc 0.3263
"""
import json
import os
...
class VCR(Dataset):
    def __init__(self, split, tasks=('0', '1', '2'), only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        if '0' in self.tasks:    # 这里对于QR2A的embedding不进行修改，因为我们只是测试不是训练，我们在后面模型部分想办法把QR2A的影响消掉就可以
