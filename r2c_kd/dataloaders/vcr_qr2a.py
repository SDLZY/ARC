...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        with open(os.path.join(VCR_ANNOTS_DIR, self.split, '{}.jsonl'.format(split)), 'r') as f:
        ...
        self.h5fn = os.path.join(VCR_ANNOTS_DIR, self.split, f'{self.embs_to_load}_{self.mode}_{self.split}.h5')
